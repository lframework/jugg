package com.lframework.starter.web.core.components.permission;
...
import com.lframework.starter.web.core.annotations.permission.DataPermissionGroup;
...
public class DataPermissionHandlerImpl implements DataPermissionHandler {
  ...
  private String getDataPermission(Class<? extends SysDataPermissionDataPermissionType> permissionTypeClazz,
      List<String> keys,
      List<String> values) {
    ...
    Assert.notNull(permissionTypeClazz);
    Assert.notNull(keys);
    Assert.notNull(values);


    SysDataPermissionDataPermissionType permissionType = ApplicationUtil.getBean(permissionTypeClazz);
  ...
  private void buildDataPermissionSql(List<String> results, DataPermissions dataPermissions) {
    Class<? extends SysDataPermissionDataPermissionType> dataPermissionType = dataPermissions.type();
