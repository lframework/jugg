...
public class ExcelMultipartWriterBuilder
   ...
   * <p>
   * WARRING:Encryption is when the entire file is read into memory, so it is very memory
   * intensive.
   *
   * @param password
   * @return
  ...
  /**
   * The default is all excel objects.if true , you can use {@link com.alibaba.excel.annotation.ExcelIgnore}
   * ignore a field. if false , you must use {@link com.alibaba.excel.annotation.ExcelProperty} to
   * use a filed.
   * <p>
   * Default true
   *
   ...
   * @return
   * @deprecated Just to be compatible with historical data, The default is always going to be
   * convert all filed.
   */
  @Deprecated
