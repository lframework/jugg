...
public class DefaultSysPositionServiceImpl implements ISysPositionService {
    ...
    @Override
    public PageResult<DefaultSysPositionDto> query(Integer pageIndex, Integer pageSize, QuerySysPositionVo vo) {
    ...
    @Override
    public PageResult<DefaultSysPositionDto> selector(Integer pageIndex, Integer pageSize, SysPositionSelectorVo vo) {
    ...
    protected void doUpdate(UpdateSysPositionVo vo) {
        ...
        LambdaUpdateWrapper<DefaultSysPosition> updateWrapper = Wrappers.lambdaUpdate(DefaultSysPosition.class)
                .set(DefaultSysPosition::getCode, vo.getCode()).set(DefaultSysPosition::getName, vo.getName())
