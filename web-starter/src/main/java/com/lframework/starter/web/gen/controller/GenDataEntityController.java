...
import com.lframework.starter.web.gen.components.generate.Generator;
...
import com.lframework.starter.web.gen.bo.data.entity.DataEntityGenerateBo;
import com.lframework.starter.web.gen.bo.data.entity.GenDataEntityDetailBo;
import com.lframework.starter.web.gen.bo.data.entity.GetDataEntityBo;
import com.lframework.starter.web.gen.bo.data.entity.QueryDataEntityBo;
...
public class GenDataEntityController extends DefaultBaseController {
  ...
  public InvokeResult<Void> enable(
    ...
    genDataEntityService.enable(id);
  ...
  public InvokeResult<Void> unable(
    ...
    genDataEntityService.unable(id);
