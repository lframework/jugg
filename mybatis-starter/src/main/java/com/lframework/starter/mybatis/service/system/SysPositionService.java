...
public interface SysPositionService extends BaseMpService<DefaultSysPosition> {
   ...
   * @return
   */
  PageResult<DefaultSysPosition> query(Integer pageIndex, Integer pageSize,
   ...
   * @return
   */
  PageResult<DefaultSysPosition> selector(Integer pageIndex, Integer pageSize,
