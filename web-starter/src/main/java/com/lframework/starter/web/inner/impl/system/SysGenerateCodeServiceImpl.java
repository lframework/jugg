...
import com.lframework.starter.web.inner.mappers.system.SysGenerateCodeMapper;
import com.lframework.starter.web.inner.service.system.SysGenerateCodeService;
...
public class SysGenerateCodeServiceImpl extends
  ...
  @OpLog(type = SystemOpLogType.class, name = "新增编号规则，ID：{}", params = {"#id"})
  ...
  @OpLog(type = SystemOpLogType.class, name = "修改编号规则，ID：{}", params = {"#id"})
  @Transactional(rollbackFor = Exception.class)
  @Override
  ...
  @OpLog(type = SystemOpLogType.class, name = "删除编号规则，ID：{}", params = {"#id"})
  @Transactional(rollbackFor = Exception.class)
  @Override
  ...
  @OpLog(type = SystemOpLogType.class, name = "设置编号规则，ID：{}", params = {"#id"})
  @Transactional(rollbackFor = Exception.class)
  @Override
