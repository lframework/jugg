...
public class UploadUtil {
     ...
     * @param locations 路径 比如想把文件存在${baseLocation}/datas/2022/01/01目录处，此时locations = ['datas', '2022', '01', '01']
     * @param fileName 文件名
     * @param baseUrl 基础url
     * @return
     */
    public static String upload(MultipartFile file, String baseLocation, List<String> locations, String fileName, String baseUrl) {
        ...
        String fullPath = baseLocation + (CollectionUtil.isEmpty(locations) ? StringPool.EMPTY_STR :CollectionUtil.join(locations, File.separator)) + File.separator;

        // 扩展名 比如jpg
        String suffix = FileUtil.getSuffix(file.getOriginalFilename());
        // 文件名 比如a.jpg
        String fullFileName = fileName + (StringUtil.isEmpty(suffix) ? StringPool.EMPTY_STR : ("." + suffix));
        ...
        return baseUrl + (CollectionUtil.isEmpty(locations) ? StringPool.EMPTY_STR : CollectionUtil.join(locations, "/") + "/") +  fullFileName;
    }
