...
public class SysMenuServiceImpl extends BaseMpServiceImpl<SysMenuMapper, SysMenu> implements
  ...
  @OpLog(type = SystemOpLogType.class, name = "新增菜单，ID：{}, 编号：{}", params = {"#id",
      "#code"})
  ...
  @OpLog(type = SystemOpLogType.class, name = "修改菜单，ID：{}, 编号：{}", params = {"#id",
      "#code"})
  @Transactional(rollbackFor = Exception.class)
  @Override
  ...
  @OpLog(type = SystemOpLogType.class, name = "删除菜单，ID：{}", params = "#id")
  @Transactional(rollbackFor = Exception.class)
  @Override
  ...
  @OpLog(type = SystemOpLogType.class, name = "启用菜单，ID：{}", params = "#id")
  @Transactional(rollbackFor = Exception.class)
  @Override
  ...
  @OpLog(type = SystemOpLogType.class, name = "停用菜单，ID：{}", params = "#id")
  @Transactional(rollbackFor = Exception.class)
  @Override
