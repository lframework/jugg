...
import com.lframework.starter.web.inner.mappers.system.SysNoticeMapper;
...
public class SysNoticeServiceImpl extends BaseMpServiceImpl<SysNoticeMapper, SysNotice> implements
  ...
  @OpLog(type = SystemOpLogType.class, name = "新增系统通知，ID：{}", params = {"#id"})
  ...
  @OpLog(type = SystemOpLogType.class, name = "修改系统通知，ID：{}", params = {"#id"})
  @Transactional(rollbackFor = Exception.class)
  @Override
  ...
  @OpLog(type = SystemOpLogType.class, name = "发布系统通知，ID：{}", params = {"#id"})
  @Transactional(rollbackFor = Exception.class)
  @Override
