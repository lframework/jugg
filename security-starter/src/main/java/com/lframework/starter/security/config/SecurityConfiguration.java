...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http.cors().and().exceptionHandling().authenticationEntryPoint(authenticationEntryPoint)
        ...
        .loginProcessingUrl(StringPool.LOGIN_API_URL)
    ...
    http.authorizeRequests()
        //登录、验证码允许匿名访问
        .antMatchers(StringPool.LOGIN_API_URL, StringPool.CAPTCHA_URL, StringPool.LOGOUT_API_URL,
            StringPool.AUTH_INIT_URL, StringPool.AUTH_REGIST_URL,
            uploadUrl.endsWith("/") ? uploadUrl + "**" : uploadUrl + "/**", "/auth/forget/**")
        .permitAll()
