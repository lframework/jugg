...
public class GenCustomListServiceImpl extends
    ...
    public String create(CreateGenCustomListVo data) {
        ...
        record.setQueryPrefixSql(StringUtil.isBlank(data.getQueryPrefixSql()) ? StringPool.EMPTY_STR : data.getQueryPrefixSql());
        record.setQuerySuffixSql(StringUtil.isBlank(data.getQuerySuffixSql()) ? StringPool.EMPTY_STR : data.getQuerySuffixSql());
        record.setSuffixSql(StringUtil.isBlank(data.getSuffixSql()) ? StringPool.EMPTY_STR : data.getSuffixSql());
    ...
    public void update(UpdateGenCustomListVo data) {
        ...
        Wrapper<GenCustomList> updateWrapper = Wrappers.lambdaUpdate(GenCustomList.class)
                ...
                .set(GenCustomList::getQueryPrefixSql, StringUtil.isBlank(data.getQueryPrefixSql()) ? StringPool.EMPTY_STR : data.getQueryPrefixSql())
                .set(GenCustomList::getQuerySuffixSql, StringUtil.isBlank(data.getQuerySuffixSql()) ? StringPool.EMPTY_STR : data.getQuerySuffixSql())
                .set(GenCustomList::getSuffixSql, StringUtil.isBlank(data.getSuffixSql()) ? StringPool.EMPTY_STR : data.getSuffixSql()).set(GenCustomList::getDescription,
