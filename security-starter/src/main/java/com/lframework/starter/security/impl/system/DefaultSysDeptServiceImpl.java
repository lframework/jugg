...
import com.lframework.starter.security.entity.DefaultSysDept;
import com.lframework.starter.security.enums.system.SysDeptNodeType;
import com.lframework.starter.security.mappers.system.DefaultSysDeptMapper;
...
public class DefaultSysDeptServiceImpl implements ISysDeptService {
    ...
    protected void doUpdate(UpdateSysDeptVo vo) {
        ...
        Wrapper<DefaultSysDept> updateWrapper = Wrappers.lambdaUpdate(DefaultSysDept.class)
                ...
                .set(DefaultSysDept::getParentId, StringUtil.isBlank(vo.getParentId()) ? null : vo.getParentId())
    ...
    protected void saveRecursion(String deptId, String parentId) {
        ...
        if (!StringUtil.isBlank(parentId)) {
            ...
            recursionMappingService.saveNode(deptId, ApplicationUtil.getBean(SysDeptNodeType.class), parentIds);
        } else {
