...
public class AliSmsServiceImpl implements IAliSmsService {
    ...
    @Override
    public SendSmsResponseBody send(String phoneNumbers, String signName, String templateCode, Map<String, Object> templateParam) {
        return send(phoneNumbers, signName, templateCode, templateParam, null, null);
    }

    @Override
    public SendSmsResponseBody send(String phoneNumbers, String signName, String templateCode, Map<String, Object> templateParam, String smsUpExtendCode) {
        return send(phoneNumbers, signName, templateCode, templateParam, smsUpExtendCode, null);
    }

    @Override
    public SendSmsResponseBody send(String phoneNumbers, String signName, String templateCode, Map<String, Object> templateParam, String smsUpExtendCode, String outId) {
        SendSmsRequest sendSmsRequest = new SendSmsRequest()
                .setPhoneNumbers(phoneNumbers)
                .setSignName(signName)
                .setTemplateCode(templateCode)
                .setTemplateParam(CollectionUtil.isEmpty(templateParam) ? null : JsonUtil.toJsonString(templateParam))
                .setSmsUpExtendCode(smsUpExtendCode)
                .setOutId(outId);

        if (log.isDebugEnabled()) {
            log.debug("【阿里短信】准备发送短信, phoneNumbers={}, signName={}, templateCode={}, templateParams={}, smsUpExtendCode={}, outId={}", phoneNumbers, signName, templateCode, templateParam, smsUpExtendCode, outId);
        }
