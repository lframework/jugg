...
public interface ISysPositionService extends BaseService {
     ...
     * @return
     */
    PageResult<DefaultSysPositionDto> query(Integer pageIndex, Integer pageSize, QuerySysPositionVo vo);
     ...
     * @return
     */
    PageResult<DefaultSysPositionDto> selector(Integer pageIndex, Integer pageSize, SysPositionSelectorVo vo);
